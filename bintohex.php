...
<div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu1' class="sidebar-submenu collapse show">
          ...
          <a href="bintohex.html" class="active list-group-item list-group-item-action">
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">Binary to Hexadecimal Converter</h5>
      <!-- MAIN -->
      <?php require_once "views/main.php"; ?>
       <div class="col-sm-4">
        <div class="bd-bq">
          ...
          <span>Cara melakukan konversi:</span>
          <p>Contoh: 100011101<sub>2</sub> = ... <sub>16</sub></p> 
          <p>Pertama bagi-bagi dulu bilangan biner tersebut menjadi masing-masing 4 bit dari kanan ke kiri.</p>
          <p>Kelompok biner 1 : 1101<br>
             Kelompok biner 2 : 0001<br>
             Kelompok biner 3 : 0001</p>
          <p>kemudian konversi kelompok-kelompok biner tersebut ke dalam bentuk desimal dimulai dari kelompok yang paling kiri sehingga menjadi :</p>
          <p>
            0001 -> 1<br>
            0001 -> 1<br>
            1101 -> D
          </p>
          <p>Jadi, 100011101<sub>2</sub> = 11D<sub>16</sub></p> 
          </figcaption>
        </div>
      </div>
      <!-- tag penutup main -->
