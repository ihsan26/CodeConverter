...
?>
 ...
 <div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu2' class="sidebar-submenu collapse show">
          ...
          <a href="asciitostr.html" class="active list-group-item list-group-item-action">
            <span class="menu-collapsed">ASCII to String</span>
          </a>
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">ASCII to String Converter</h5>
      <!-- MAIN -->
      <?php require_once "views/main.php"; ?>
      <div class="col-sm-4">
        <div class="bd-bq">
          <h6>Catatan:</h6>
          <figcaption class="figure-caption font-weight-light"><p class="text-justify">ASCII merupakan kepanjangan dari (American Standard Code for Information Interchange), dan pengertian dari ASCII sendiri adalah suatu standar internasional dalam kode huruf dan simbol seperti Hex dan Unicode tetapi ASCII lebih bersifat universal, contohnya 124 adalah untuk karakter "|". Ia selalu digunakan oleh komputer dan alat komunikasi lain untuk menunjukkan teks.</p>
          </figcaption>
        </div>
      </div>
      <!-- tag penutup main -->
