...
<div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu3' class="sidebar-submenu collapse show">
          ...
          <a href="iptobin.html" class="active list-group-item list-group-item-action">
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">IP Address to Binary Converter</h5>
      <!-- MAIN -->
      <div class="col-sm-8">
        ...
        <?php if(isset($_POST['convert'])): ?>
          <h6 class="font-weight-normal">Biner dari IP address <?= $input; ?>  adalah <span class="font-weight-bold"><?= $hasil; ?></span></h6>
        <?php endif; ?>
       </div>
       </div>
