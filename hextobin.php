...
<div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu1' class="sidebar-submenu collapse show">
          ...
          <a href="hextobin.html" class="active list-group-item list-group-item-action">
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">Hexadecimal to Binary Converter</h5>
      <!-- MAIN -->
      ...
      <div class="col-sm-4">
        <div class="bd-bq">
          ...
          <p>Cara untuk mengkonversikan bilangan hexadesimal ke biner yaitu dengan memecah satu persatu bilangan-bilangan hexadesimal tersebut kemudian dikonversikan ke bilangan biner 4 digit.</p>
          <p>Contoh: F67<sub>16</sub> = ... <sub>2</sub></p> 
          <p>Kita pisahkan F67 menjadi F, 6 dan 7, kemudian kita konversi satu persatu ke biner 4 digit.</p>
          <p>F = 1111<br>
             6 = 0110<br>
             7 = 0111</p>
          <p>Jadi, F67<sub>16</sub> = 111101100111<sub>2</sub></p> 
          </figcaption>
        </div>
      </div>
      <!-- tag penutup main -->
