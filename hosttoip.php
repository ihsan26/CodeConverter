...
?>
 ...
 <div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu3' class="sidebar-submenu collapse show">
          ...
          <a href="hosttoip.html" class="active list-group-item list-group-item-action">
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">Host to IP Address Converter</h5>
      <!-- MAIN -->
      <div class="col-sm-8">
				<form action="" method="post">
        <label for="formGroupExampleInput">Masukkan Hostname</label>
          <div class="form-row">
            <div class="col-sm-6">           
        ...
        <?php if(isset($_POST['convert'])): ?>
          <h6 class="font-weight-normal">IP address dari hostname <?= $input; ?>  adalah <span class="font-weight-bold"><?= $hasil; ?></span></h6>
        <?php endif; ?>
       </div>
       </div>
