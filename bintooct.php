...
?>
  <div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu1' class="sidebar-submenu collapse show">
          ...
          <a href="bintooct.html" class="active list-group-item list-group-item-action">
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">Binary to Octal Converter</h5>
      <!-- MAIN -->
      ...
      <div class="col-sm-4">
        <div class="bd-bq">
          ...
          <p>Contoh: 100011101<sub>2</sub> = ... <sub>8</sub></p> 
          <p>Pertama bagi-bagi dulu bilangan biner tersebut menjadi masing-masing 3 bit dari kanan ke kiri.</p>
          <p>Kelompok biner 1 : 101<br>
             Kelompok biner 2 : 011<br>
             Kelompok biner 3 : 100</p>
          ...
          <p>Jadi, 100011101<sub>2</sub> = 435<sub>8</sub></p> 
          </figcaption>
        </div>
      </div>
      <!-- tag penutup main -->
