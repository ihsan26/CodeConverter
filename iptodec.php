...
<div class="row margin-atas" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
      <ul class="list-group">
        ...
        <div id='submenu3' class="sidebar-submenu collapse show">
          ...
          <a href="iptodec.html" class="active list-group-item list-group-item-action">
    ...
    <div class="col-sm-9">
      <h5 class="border-dark border-bottom pt-4 pb-4 text-secondary font-weight-bold">IP Address to Decimal Converter</h5>
      <!-- MAIN -->
      <div class="col-sm-8">
        <form action="" method="post">
        <label for="formGroupExampleInput">Masukkan IP address</label>
          <div class="form-row">
            <div class="col-sm-6">           
              <input type="text" class="form-control" id="formGroupExampleInput" name="input" autocomplete="off" value="<?= isset($_POST['convert'])? $input: ''; ?>">
            </div>
            <button type="convert" name="convert" class="btn btn-custom mrsub">Convert</button>
          </div>
        </form>
        <br>
        <?php if(isset($_POST['convert'])): ?>
          <h6 class="font-weight-normal">Desimal dari IP address <?= $input; ?>  adalah <span class="font-weight-bold"><?= $hasil; ?></span></h6>
        <?php endif; ?>
       </div>
       </div>
